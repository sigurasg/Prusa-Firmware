...
#ifdef TMC2130
    { TMC2130_USTEPS_X, TMC2130_USTEPS_Y, TMC2130_USTEPS_Z, TMC2130_USTEPS_E }, // CLX adjust for individual Kuo Steppers
#else // TMC2130
    {16,16,16,16},
#endif
...
bool Config_RetrieveSettings()
{
    ...
    if (strncmp(ver,cs.version,3) == 0)  // version number match
    {
		...
		if(cs.axis_ustep_resolution[Y_AXIS] == 0xff){ cs.axis_ustep_resolution[Y_AXIS] = TMC2130_USTEPS_X; } //Kuo
